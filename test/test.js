        ...
        axios
          ...
          .then((respon) => {
            ...
            if (
              ...
              let hasil = [];
              ch(
                "body > div.welcome.section > div > div:nth-child(3) > div > div.row > div"
              ).each(function (a, b) {
                hasil.push({
              ...
              let result = {
                audio: ch(
                  "body > div.welcome.section > div > div:nth-child(3) > div > a.btn.waves-effect.waves-light.orange.download"
                ).attr("href"),
                photo: hasil,
              };
              if (!result.photo[0]) {
