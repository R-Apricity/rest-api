...
let voicegenurl = process.env.VCGEN_URL || "plachta-vits-umamusume-voice-synthesizer.hf.space"
...
const errorHandlerMiddleware = (err, req, res, next) => {
  res.status(500).json({ error: err.message, errordebug: typeof err == "object" ?  { message: err.message, stack: err.stack, name: err.name } : err.toString() });
};
